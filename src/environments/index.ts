...
// author
const AUTHOR: string = process.env.AUTHOR || 'thepembeweb'
...
const MLAB_PASS = process.env.MLAB_PASS || 'graphqlsecret'
...
// jsonwebtoken
const ISSUER: string = process.env.ISSUER || 'thepembeweb corp'
const AUDIENCE: string = process.env.AUDIENCE || 'http://thepembeweb.github.io'
...
// cloudinary
const CLOUDINARY_NAME: string = process.env.CLOUDINARY_NAME || 'thepembeweb'
