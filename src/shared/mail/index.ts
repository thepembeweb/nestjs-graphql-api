...
export const sendMail = async (
	...
	readHTMLFile('./src/assets/templates/udacity-index.html', (err, html) => {
		...
		const common = {
			author: AUTHOR,
			issuer: ISSUER,
			ios: 'https://itunes.apple.com/us/app/thepembeweb',
			android: 'https://play.google.com/store/apps/thepembeweb',
			twitter: 'https://twitter.com/thepembeweb',
			facebook: 'https://www.facebook.com/trinhchinchinn',
			googleplus: 'https://plus.google.com/thepembeweb',
			linkedin:
		...
		const mailOptions = {
			from: 'thepembeweb  📮:' + NODEMAILER_USER, // sender address
